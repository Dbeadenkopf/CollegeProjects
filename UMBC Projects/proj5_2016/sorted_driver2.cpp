/
// sorted_driver.cpp : minimal test program for sorted<T> class and iterat\
ors
//
...
int main() {
  ...
  for ( rndsongitr = songs.rndbegin(); rndsongitr != songs.rndend(); rndso\
	  ngitr++ )
  ...
  cout << endl;
  cout << "My Prince songs (copy with 'Joy in Repetition' deleted):" << en\
    dl;
