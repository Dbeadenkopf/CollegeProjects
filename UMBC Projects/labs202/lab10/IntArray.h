...
public:
    ...
    // error wih just using int, if non negaive, needs to be unsigned int
    // error 2, cannot set size equal to default val if it is initilized to 0 before passin values in
    /*
...
private:
    ...
    static std::set<int> errorsFound; // im assuming im suppose to use this 
